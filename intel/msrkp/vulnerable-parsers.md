# Vulnerable URL Parsers - Prototype Pollution Vectors

Source: msrkp/PPScan database.csv
Value: These URL parsers are known to be vulnerable to prototype pollution

## Known Vulnerable Parsers
...
Unknown Lib 9|text|queryParamsToObject
```

## Value for Titan
- Can be used to detect vulnerable libraries in targets
- Shows patterns to look for in JavaScript code
- Can be integrated into Titan's scanner
- Direct mapping to sturdy-octo findings (URL parser vulnerability confirmed)
