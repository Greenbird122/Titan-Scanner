...
KNOWN_VULNERABLE: dict[str, list[dict]] = {
    ...
    "minimist": [
        {"cve": "CVE-2021-44906", "versions": "<1.2.6", "severity": "critical", "description": "Prototype pollution"},
    ],
    "node-fetch": [
        {
            "cve": "CVE-2022-0235",
    ...
    "axios": [
        {"cve": "CVE-2023-45857", "versions": "<1.6.0", "severity": "medium", "description": "CSRF token exposure"},
    ],
    "express": [
        {"cve": "CVE-2024-29041", "versions": "<4.19.2", "severity": "medium", "description": "Open redirect"},
    ],
    "webpack": [
        {
            "cve": "CVE-2023-28154",
    ...
    "shell-quote": [
        {"cve": "CVE-2021-42740", "versions": "<1.7.3", "severity": "critical", "description": "Command injection"},
    ],
    "tar": [
        {
            "cve": "CVE-2021-37701",
    ...
    "json5": [
        {"cve": "CVE-2022-46175", "versions": "<2.2.2", "severity": "high", "description": "Prototype pollution"},
    ],
    "semver": [
        {
            "cve": "CVE-2022-25883",
    ...
    "xml2js": [
        {"cve": "CVE-2023-0842", "versions": "<0.5.0", "severity": "medium", "description": "Prototype pollution"},
    ],
    "glob-parent": [
        {"cve": "CVE-2021-35065", "versions": "<5.1.2", "severity": "high", "description": "ReDoS"},
    ],
    "qs": [
        {"cve": "CVE-2022-24999", "versions": "<6.10.3", "severity": "high", "description": "Prototype pollution"},
    ],
    "django": [
        {
            "cve": "CVE-2024-24680",
    ...
    "werkzeug": [
        {"cve": "CVE-2023-46136", "versions": "<3.0.1", "severity": "high", "description": "DoS via multipart parsing"},
    ],
    "pillow": [
        {"cve": "CVE-2023-44271", "versions": "<10.0.0", "severity": "medium", "description": "DoS via crafted image"},
    ],
    "requests": [
        {
            "cve": "CVE-2023-32681",
...
class SBOMAnalyzer:
    ...
    def _parse_cdn_url(self, url: str) -> DependencyInfo | None:
        ...
        match = re.match(r"https?://cdn\.jsdelivr\.net/npm/([^@/]+)@?([^/]*)", url)
        if match:
        ...
        match = re.match(r"https?://unpkg\.com/([^@/]+)@?([^/]*)", url)
        if match:
            return DependencyInfo(
                name=match.group(1),
                version=match.group(2) or "latest",
        ...
        match = re.match(r"https?://ajax\.googleapis\.com/ajax/libs/([^/]+)/([^/]+)/", url)
        if match:
            return DependencyInfo(
                name=match.group(1),
        ...
        # Cloudflare CDN
        match = re.match(r"https?://cdnjs\.cloudflare\.com/ajax/libs/([^/]+)/([^/]+)/", url)
        if match:
            return DependencyInfo(
                name=match.group(1),
                version=match.group(2),
    ...
    def _extract_inline_dependencies(self, content: str) -> list[DependencyInfo]:
        ...
        for match in re.finditer(
            r"""['"]https?://[^'"]*(?:cdn\.jsdelivr\.net|unpkg\.com|ajax\.googleapis\.com)[^'"]*['"]""", content
        ):
    ...
    def _generate_findings(self, report: SBOMReport) -> list[dict]:
            ...
            findings.append(
                {
                    ...
                    "evidence": (
                        f"External scripts/stylesheets without SRI hashes from: {', '.join(sorted(origins)[:5])}"
                    ),
                    "oracle": "sri_missing",
                    "tier": "confirmed",
        ...
        risky_origins = {
            name: info
            for name, info in report.origins.items()
            ...
            findings.append(
                {
                    ...
                    "evidence": (f"External origins with no CDN trust: {list(risky_origins.keys())[:5]}"),
