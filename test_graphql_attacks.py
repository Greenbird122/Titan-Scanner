...
# 2. Try with old key
old_key = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5oeXltcWZwd2V5d3l4Ym11aSIsInJvbGUiOiJhbm9uIiwiaWF0IjoxNzgwMjk5MjkwLCJleHAiOjIwOTU4NzUyOTB9.REMOVED-LEAKED-SUPABASE-ANON-KEY'
r = requests.post(url, json={'query': 'query { __schema { queryType { fields { name } } } }'}, 
